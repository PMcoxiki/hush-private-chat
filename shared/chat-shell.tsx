  ...
  return (
    <main className="app-shell">
      <section className="phone-app" aria-label="ChatGPT 移动对话">
        ...
        <input ref={cameraInputRef} className="file-input" type="file" accept="image/*" capture="environment" onChange={(event) => addFiles(event, "photo")} />
        <input ref={photoInputRef} className="file-input" type="file" accept="image/*" multiple onChange={(event) => addFiles(event, "photo")} />
        <input ref={fileInputRef} className="file-input" type="file" multiple onChange={(event) => addFiles(event, "file")} />
